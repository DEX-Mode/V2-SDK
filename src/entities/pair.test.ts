...
import { ChainId, CurrencyAmount, Price, Token, V2_FACTORY_ADDRESSES, WETH9 } from 'udonswap-sdk-core'
import { InsufficientInputAmountError } from '../errors'
import { computePairAddress, Pair } from './pair'

describe('computePairAddress', () => {
  it('should correctly compute the pool address', () => {
    const tokenA = new Token(919, '0xF7ca2401709BC01Eba07d46c8d59e865C983e1AC', 18, 'DAI', 'DAI Stablecoin')
    const tokenB = new Token(919, '0x4Bd692dbA81074BC2FA9abDcffE7324680d7A1c1', 18, 'USDC', 'USD Coin')
    const result = computePairAddress({
      factoryAddress: '0x2eeFa13703Eb4483Aa588Fd5D6bfb034E1FB8d97',
      tokenA,
      tokenB
    })
    console.log(result)
...
describe('Pair', () => {
  ...
  describe('#getAddress', () => {
    it('returns the correct address', () => {
      console.log(Pair.getAddress(USDC, DAI))
      expect(Pair.getAddress(USDC, DAI)).toEqual('0x115253bcd7D2c7ca706ca8605eE4Fd7D5fCEEBA0')
    })
